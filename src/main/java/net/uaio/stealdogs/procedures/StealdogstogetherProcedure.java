package net.uaio.stealdogs.procedures;
...
public class StealdogstogetherProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator == ((Entity) world.getEntitiesOfClass(Wolf.class, AABB.ofSize(new Vec3(x, y, z), 4, 4, 4), e -> true).stream().sorted(new Object() {
